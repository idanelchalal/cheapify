    ...
    if (small)
        return (
            <>
                <div
                    id="logo-wrapper"
                    className="select-none gap-x-1 flex items-center tracking-wider"
                >
                    <Image
                    ...
                    <div id="typo-wrapper" className="p-0 m-0 flex flex-col">
                        <h3 className="bg-gradient-to-r text-transparent w-auto text-lg font-semibold from-yellow-300 to-orange-500 bg-clip-text">
                            Cheapify
                        </h3>
                        <span className="text-neutral-400 tracking-tighter text-[10px] cursor-default">
